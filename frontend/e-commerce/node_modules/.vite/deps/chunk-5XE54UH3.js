...
function D(t2, e, o = true) {
  ...
  if (t2) {
    ...
    f2.top + u + s4 > lt.height ? (L = f2.top + g3 - s4, ot = "bottom", L < 0 && (L = g3)) : L = u + f2.top + g3, f2.left + a2 > lt.width ? N3 = Math.max(0, f2.left + it + p2 - a2) : N3 = f2.left + it, V2(t2) ? t2.style.insetInlineEnd = N3 + "px" : t2.style.insetInlineStart = N3 + "px", t2.style.top = L + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n = x2(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (l2 = (i2 = x2(/-anchor-gutter$/)) == null ? void 0 : i2.value) != null ? l2 : "");
  }
}
function S(t2, e) {
...
function j(t2, e) {
  ...
  if (t2) switch (t2) {
    ...
    default: {
      ...
      let l2 = ((s4) => typeof s4 == "function" && "call" in s4 && "apply" in s4)(t2) ? t2() : t2, d2 = H2(l2);
...
function zt(t2, e) {
  var o, n;
  if (t2) {
    let r = t2.parentElement, i2 = K2(r), l2 = h2(), d2 = t2.offsetParent ? t2.offsetWidth : J2(t2), s4 = t2.offsetParent ? t2.offsetHeight : G2(t2), a2 = v((o = r == null ? void 0 : r.children) == null ? void 0 : o[0]), u = C2((n = r == null ? void 0 : r.children) == null ? void 0 : n[0]), p2 = "", f2 = "";
    i2.left + a2 + d2 > l2.width - O2() ? i2.left < d2 ? e % 2 === 1 ? p2 = i2.left ? "-" + i2.left + "px" : "100%" : e % 2 === 0 && (p2 = l2.width - d2 - O2() + "px") : p2 = "-100%" : p2 = "100%", t2.getBoundingClientRect().top + u + s4 > l2.height ? f2 = `-${s4 - u}px` : f2 = "0px", t2.style.top = f2, t2.style.insetInlineStart = p2;
  }
}
function Kt(t2, e) {
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  var R2, T2, j2, O3, M3, z3, V3;
  let { preset: a2, options: n } = t2, l2, o, c3, m2, d2, u, g3;
  if (s(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te2, extend: re2 } = a2, f2 = te2 || {}, { colorScheme: K3 } = f2, A2 = v2(f2, ["colorScheme"]), x4 = re2 || {}, { colorScheme: X2 } = x4, G3 = v2(x4, ["colorScheme"]), p2 = K3 || {}, { dark: U2 } = p2, B3 = v2(p2, ["dark"]), y3 = X2 || {}, { dark: I2 } = y3, H3 = v2(y3, ["dark"]), W3 = s(L) ? this._toVariables({ primitive: L }, n) : {}, q3 = s(A2) ? this._toVariables({ semantic: A2 }, n) : {}, Z = s(B3) ? this._toVariables({ light: B3 }, n) : {}, pe = s(U2) ? this._toVariables({ dark: U2 }, n) : {}, fe = s(G3) ? this._toVariables({ semantic: G3 }, n) : {}, ye = s(H3) ? this._toVariables({ light: H3 }, n) : {}, Se = s(I2) ? this._toVariables({ dark: I2 }, n) : {}, [Me, ze] = [(R2 = W3.declarations) != null ? R2 : "", W3.tokens], [Ke, Xe] = [(T2 = q3.declarations) != null ? T2 : "", q3.tokens || []], [Ge, Ue] = [(j2 = Z.declarations) != null ? j2 : "", Z.tokens || []], [Be, Ie] = [(O3 = pe.declarations) != null ? O3 : "", pe.tokens || []], [He, We] = [(M3 = fe.declarations) != null ? M3 : "", fe.tokens || []], [qe, Ze] = [(z3 = ye.declarations) != null ? z3 : "", ye.tokens || []], [Fe, Je] = [(V3 = Se.declarations) != null ? V3 : "", Se.tokens || []];
  ...
  if (s(t2) && r.transform !== "strict") {
    let y3 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j2 } = m2, O3 = v2(m2, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M3 } = d2, z3 = v2(d2, ["colorScheme"]), u = R2 || {}, { dark: V3 } = u, L = v2(u, ["dark"]), g3 = M3 || {}, { dark: te2 } = g3, re2 = v2(g3, ["dark"]), K3 = s(O3) ? this._toVariables({ [y3]: h3(h3({}, O3), z3) }, r) : {}, A2 = s(L) ? this._toVariables({ [y3]: h3(h3({}, L), re2) }, r) : {}, X2 = s(V3) ? this._toVariables({ [y3]: h3(h3({}, V3), te2) }, r) : {}, [G3, U2] = [(f2 = K3.declarations) != null ? f2 : "", K3.tokens || []], [B3, I2] = [(x4 = A2.declarations) != null ? x4 : "", A2.tokens || []], [H3, W3] = [(p2 = X2.declarations) != null ? p2 : "", X2.tokens || []], q3 = this.transformCSS(y3, `${G3}${B3}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y3, H3, "dark", "variable", r, i2, a2, n);
    l2 = `${q3}${Z}`, o = [.../* @__PURE__ */ new Set([...U2, ...I2, ...W3])], c3 = m(j2, { dt: E2 });
  }
...
//# sourceMappingURL=chunk-5XE54UH3.js.map
