...
var BaseDirective = {
  ...
  _extend: function _extend(name) {
    ...
    var handleHook = function handleHook2(hook, el, binding, vnode, prevVnode) {
      ...
      var $options = l($prevInstance) ? _objectSpread2(_objectSpread2({}, options), options === null || options === void 0 ? void 0 : options.methods) : {};
...
var script2 = {
  ...
  methods: {
    pti: function pti() {
      ...
      return _objectSpread3(_objectSpread3({}, !this.isUnstyled && {
        "class": ["p-icon", {
...
//# sourceMappingURL=chunk-EJRL4XXT.js.map
